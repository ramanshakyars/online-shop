...
function Navbar({ searchText, setSearchText }) {
  return (
    <div>
      <nav className="relative position-relative bg-gray-800/50 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
